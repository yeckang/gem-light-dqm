...
if [ -r $1 ]; then
  ...
  g++ -g -std=c++0x -I/usr/include/root -I${BUILD_HOME}/${GEM_OS_PROJECT}/gemreadout/include -I${BUILD_HOME}/dqm-light/include $1 `root-config --libs --glibs` -o myTTreeDQMLight
