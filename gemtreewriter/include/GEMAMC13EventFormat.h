...
class GEBdata
{
  private:
    ...
    //GEM chamber trailer
      ...
      //!OH BC, bits [31:20]
      uint16_t m_OHBC;
      //!Optohybrid BC/EC FIFO underflow, bit [19:19]
      uint8_t m_OHECBCUF; 
      //!Optohybrid BC/EC FIFO had underflow, bit [18:18]
      uint8_t m_OHECBCHUF; 
      //!Optohybrid BC/EC FIFO had overflow, bit [17:17]
      uint8_t m_OHECBCHOF;
      //!BC0 is canceled by an L1A, bit [16:16]
      uint8_t m_BC0Canc;
      //!OH EC, bits [15:0]
      uint16_t m_OHEC;
  ...
  public:
    ...
    GEBdata(const uint16_t &ZeroSupWordsCnt_, 
          ...
          m_Stuckd(Stuckd_),
          m_OHBC(OHBC_),
	  m_OHECBCUF(OHECBCUF_),
	  m_OHECBCHUF(OHECBCHUF_),
	  m_OHECBCHOF(OHECBCHOF_),
	  m_BC0Canc(BC0Canc_),
          m_OHEC(OHEC_){}  
    //!Destructor for the class.
    ~GEBdata(){vfatd.clear();}
    ...
    */
    void setChamberTrailer(uint64_t word)
    {
      ...
      m_OHECBCUF = 0x01 & (word >> 19); /*!Optohybrid EC/BC FIFO underflow*/
    ...
    uint8_t  OHECBCUF()   {return m_OHECBCUF;}    ///<Returns OH EC/BC FIFO underflow flag
...
class AMCdata
{
  ...
  public:
    ...
    */
    ...
    void LE(uint8_t helper){Err=true;ErrCode=helper;}
...
class AMC13Event
{
  ...
  public:
    ...
    */
    ...
    bool Errgfint i){return (m_AMC_errorStrip.at(i)&0x40==0x40)||(m_AMC_errorStrip.at(i)&0b1==0b1)||(m_AMC_errorStrip.at(i)&0b10==0b10);}
